 ...
 * @package formazione
 */
class MezziPiuOrari extends BaseClass {

	function MezziPiuOrari(&$hCtx, &$hSessionCtx, $fNoWork=false ) {
	...
	private function lista() {
		...
		GestioneLingua::caricaDizionario($smarty, "AmministrazioneListaMezziPiuOrari");

		$this->listaMezziPiuOrari();

        $smarty->assign("modulo", $this->modulo);

		$this->setPaginaDaMostrare($smarty->fetch('amministrazione/mezziPiuOrari/lista.tpl'));
	}
