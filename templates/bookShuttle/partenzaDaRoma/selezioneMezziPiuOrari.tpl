...
<script>
    ...
    function validaForm() {
        ...
        indirizzoDestinazione = validazioneIndirizzoRaccolta();
                        ...
                        <div class="6u 12u(mobile)">
                            <div class="select-wrapper">
                                <select name="mezzoPiuOrario" id="mezzoPiuOrario">
                                    <option value="">{#mezzoPiuOrarioDiPartenza#}</option>
    ...
    <script>
        ...
        function initAutocomplete() {
            ...
            autocomplete = new google.maps.places.Autocomplete(
                /** @type {!HTMLInputElement} */(document.getElementById('indirizzoRaccoltaShuttle')),
                {types: ['geocode']});
